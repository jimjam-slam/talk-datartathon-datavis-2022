...
# [HEADING:<br>[blah blah[blah]{.hl .hl-purple}]{style="font-size:75%;"}]{style="color:white"} { background="linear-gradient(45deg, #4a00e0, #ff0099)"}

::: {.notes}
XXX
:::

## XXX {.text-indigo-pink style="text-align:center"}
